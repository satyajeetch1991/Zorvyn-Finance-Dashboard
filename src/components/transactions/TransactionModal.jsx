...
export function TransactionModal({ open, onClose, transaction }) {
    ...
    const validate = () => {
        ...
        if (form.description.length > 100)
            e.description = "Max 100 characters";
        setErrors(e);
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              {["income", "expense"].map((t) => (<button key={t} onClick={() => setForm({ ...form, type: t })} className={`flex-1 py-2 rounded-lg text-sm font-medium border transition-colors capitalize ${form.type === t
                ? t === "income"
